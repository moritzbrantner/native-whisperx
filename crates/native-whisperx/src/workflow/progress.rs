...
///
/// Cancellation remains sticky and Native WhisperX workflows still stop at
/// product-owned safe composition boundaries rather than interrupting a model
/// invocation or output write.
